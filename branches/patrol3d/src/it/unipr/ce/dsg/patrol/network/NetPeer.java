...
import it.unipr.ce.dsg.patrol.gui.RTSGameGUI;
import it.unipr.ce.dsg.patrol.network.message.ConnectMessage;
import it.unipr.ce.dsg.patrol.network.message.FindSuccMessage;
import it.unipr.ce.dsg.patrol.network.message.GetPredMessage;
import it.unipr.ce.dsg.patrol.network.message.GetResourceMessage;
import it.unipr.ce.dsg.patrol.network.message.InfoNewPredMessage;
import it.unipr.ce.dsg.patrol.network.message.InfoNewSuccMessage;
import it.unipr.ce.dsg.patrol.network.message.InfoPeerMessage;
import it.unipr.ce.dsg.patrol.network.message.NetMessageListener;
import it.unipr.ce.dsg.patrol.network.message.NotifyMessage;
import it.unipr.ce.dsg.patrol.network.message.PublishResourceMessage;
...
//	private NetSharedResource sharedInfos = null;
	...
	private InfoPassing requestToFindSuccessor(String to, String id, String reqOwner) throws InterruptedException {
		...
		if (this.fingerTable.containsKey(to)) {
			...
			//System.out.println("--->close Pred is the successor");
