package it.unipr.ce.dsg.patrol.network.test.multi;
...
/**
 *
 * This class provide the structure for message Print Resources on an
 * existing peer in a Chord-like network. Is used for ask the peer to print
 * all resources saved on cache.
 *
 * @author Stefano Sebastio (stefano.sebastio@studenti.unipr.it)
 *
 */
public class CacheResourceMessage extends Message {
	 ...
	 *
	 */
	public CacheResourceMessage(String sourceName, String sourceSocketAddr, int sourcePort, String time) {

		super(sourceName,sourceSocketAddr,sourcePort);

		this.setMessageType("RESOURCES");
	 ...
	 *
	 */
	public CacheResourceMessage(Message message){
