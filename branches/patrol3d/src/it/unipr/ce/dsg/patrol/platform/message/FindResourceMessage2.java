...
public class FindResourceMessage2 extends Message{
	/**
...
//	private double vis;
	...
	//cosi' da poter rintracciare il propietario della vecchia posizione che verifichera' l'ammissiblita' della richiesta
	 ...
	 *
	 */
	public FindResourceMessage2(String sourceName, String sourceSocketAddr, int sourcePort, String username,
			String position, double x, double y, double z, String oldPos) {

		super(sourceName,sourceSocketAddr,sourcePort);

		this.setMessageType("FINDRESOURCE2");
	 ...
	 *
	 */
	public FindResourceMessage2(Message message){
