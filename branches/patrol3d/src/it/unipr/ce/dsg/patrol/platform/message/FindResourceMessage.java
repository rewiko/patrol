 ...
 *
 */
public class FindResourceMessage extends Message {
...
//	private double vis;
	 ...
	 *
	 */
	public FindResourceMessage(String sourceName, String sourceSocketAddr, int sourcePort, String username,
			String position, double x, double y, double z, String oldPos) {

		super(sourceName,sourceSocketAddr,sourcePort);

		this.setMessageType("FINDRESOURCE");
	 ...
	 *
	 */
	public FindResourceMessage(Message message){
