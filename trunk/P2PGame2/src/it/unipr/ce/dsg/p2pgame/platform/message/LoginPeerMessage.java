 ...
 *
 */
public class LoginPeerMessage extends Message {
	 ...
	 *
	 */
	public LoginPeerMessage(String sourceName, String sourceSocketAddr, int sourcePort, String username, String password) {

		super(sourceName,sourceSocketAddr,sourcePort);

		this.setMessageType("LOGIN");
	 ...
	 *
	 */
	public LoginPeerMessage(Message message){
