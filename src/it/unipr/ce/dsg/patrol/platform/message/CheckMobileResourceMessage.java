 ...
 *
 */
public class CheckMobileResourceMessage extends Message {
	 ...
	 *
	 */
	public CheckMobileResourceMessage(String sourceName, String sourceSocketAddr, int sourcePort, String id, String username,
		...
		this.setMessageType("CHECKMOBILERESOURCE");
		this.PARAMETERS_NUM = 14;
	 ...
	 *
	 */
	public CheckMobileResourceMessage(Message message){
		...
		this.owner = this.getParametersList().get(11).getValue();
		this.ownerId = this.getParametersList().get(12).getValue();
		this.quantity = Double.parseDouble(this.getParametersList().get(13).getValue());
	}
