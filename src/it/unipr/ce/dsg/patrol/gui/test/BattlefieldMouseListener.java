...
import it.unipr.ce.dsg.patrol.gui.message.PositionMessage;
import it.unipr.ce.dsg.patrol.gui.message.content.Point;
import it.unipr.ce.dsg.patrol.gui.test.KnowledgeSpace.SpaceType;
...
import it.unipr.ce.dsg.patrol.rtsdemo.*;
...
MouseMotionListener {
		...
		public BattlefieldMouseListener(JLabel x, JLabel y, int g, JPanel panel, GamePeer gp, BattlefieldPanel bf){
			...
			this.bf = bf;
                         ...
                         this.request=new MessageDispatcher();
				...
				if (kl.getType() == SpaceType.UNKNOW || kl.getType() == SpaceType.SPACE ){
					...
					if (kl.getElement() == null){
					 ...
					 /////////////////////////////////************************/////////////////////
                                        ...
                                        String gpdes="";
                                       // try {
                                            gpdes = this.request.getGamePeerDescription();
                                         //   } catch (UnknownHostException ex) {
                                           // Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
                                           // } catch (IOException ex) {
                                           // Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
                                            //}
                                        System.out.println("252 gamepeerdesc");

                                        System.out.println(gpdes);
                                        /////////////////////////////////************************/////////////////////
                                     ...
                                     //       } catch (UnknownHostException ex) {
                                       //         Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
                                         //   } catch (IOException ex) {
                                           ...
                                           // }
                                         System.out.println("271 multilog "+id);
                                         MultiLog.println(BattlefieldMouseListener.class.toString(),id);
					...
					//if (player.getId().compareTo(this.gp.getMyId()) == 0){
						...
						/////////////////////////********************************/
                                            ...
                                            //    try {
                                                res = this.request.getResources();
                                               System.out.println("321 Risorse");
                                              //      } catch (UnknownHostException ex) {
                                                //        Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
                                                  //  } catch (IOException ex) {
                                                    //    Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
										...
										public void itemStateChanged(ItemEvent e) {
										    ...
										    selection = choice.getSelectedIndex();
                                                                                 ...
                                                                                 //   try {
                                                                                            ...
                                                                                            qt.setText(Double.toString(request.getMyResourceFromId(attack.get(selection)).getQuantity()));

                                                                                            System.out.println("344 resource from id");
                                                                                   //     } catch (UnknownHostException ex) {
                                                                                     //       Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
                                                                                       // } catch (IOException ex) {
                                                                                         //   Logger.getLogger(BattlefieldMouseListener.class.getName()).log(Level.SEVERE, null, ex);
						...
						public void run() {
							try {
								...
								/*****
                                                               ...
                                                               // try {
                                                                        res = request.getMobileResource(resId);
                                                               ...
                                                               // } catch (UnknownHostException ex) {
                                                                ...
                                                                while(!band)
                                                                {
                                                                    ...
                                                                    if((res.getX()!=x_target) ||(res.getY()!=y_target))
                                                                    {
                                                                        System.out.println("MOV_RESOURCE2 "+ res.getX() + "  "+res.getY());
                                                                        bf.repaint();
                                                                    }
                                                                    else
                                                                    {
                                                                ...
                                                                /**********************
                                                                GameResourceMobile res = request.getMobileResource(resId);
                                                                //GameResourceMobile res = gp.getMyMobileResourceFromId(resId);

								while(res.getX() != x_target || res.getY() != y_target) {
									Thread.sleep(500);
                                                                        System.out.println("RES_POS:" +res.getX()+ "   "+ res.getY());
									...
									if( (movX + movY) > res.getVelocity() ){
										...
										System.exit(1);
                                                                    ...
                                                                    //    try {
                                                                            ...
                                                                            //    System.out.println("478 move resource mobile");
                                                                             //   request.moveResourceMobile(resId, movX, movY, 0, threadId);
