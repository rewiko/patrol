...
/**
 *
 * This class provide the structure for message Search Resource on an
 * existing peer in a Chord-like network. Is used for ask the peer to
 * search a resource with a random id.
 *
 * @author Stefano Sebastio (stefano.sebastio@studenti.unipr.it)
 *
 */
public class SearchResourceMessage extends Message {
	 ...
	 *
	 */
	public SearchResourceMessage(String sourceName, String sourceSocketAddr, int sourcePort, String time) {

		super(sourceName,sourceSocketAddr,sourcePort);

		this.setMessageType("SEARCH");
	 ...
	 *
	 */
	public SearchResourceMessage(Message message){
